...
import de.benjaminaaron.ontoengine.domain.suggestion.job.task.LocalVocabularyMatchingTask;
import de.benjaminaaron.ontoengine.domain.suggestion.job.task.WikidataMatchingTask;
import de.benjaminaaron.ontoengine.domain.suggestion.job.NewStatementJob;
import de.benjaminaaron.ontoengine.domain.suggestion.job.PeriodicJob;
import de.benjaminaaron.ontoengine.domain.suggestion.job.task.CaseSensitivityTask;
import de.benjaminaaron.ontoengine.domain.suggestion.job.task.PeriodicQueryTask;
import de.benjaminaaron.ontoengine.domain.suggestion.job.task.SynonymsTask;
